...
const buttonVariants = cva(
  // cursor-pointer in the BASE, not per-variant: the stylesheet declared
  // cursor: pointer six times and never once on a <Button>, so every button
  // in the app showed an arrow while the prose beside it showed an I-beam.
  // disabled:pointer-events-none in the same string handles the disabled
  // case, so no variant needs to opt out.
